...
<head>
 ...
 if(isset($_POST['c_register'])){
   ...
   if(mysql_num_rows($duplicate)>0){
     ...
     $query = mysqli_query($con,"INSERT INTO customer (c_f_name,c_phn,c_email,c_add,c_pin,c_pass,c_img,c_L_name,c_age,c_gen,c_city,c_state) value('$c_f_name','$c_phn','$c_email','$c_add','$c_pin','$c_pass','$c_img','$c_L_name','$c_age','$c_gen','$c_city','$c_state')");
